...
const S = {
  page: { minHeight: "100vh", background: "#17120F", color: "#F6EEE8", padding: "48px 20px", fontFamily: "inherit" },
  wrap: { maxWidth: 1100, margin: "0 auto" },
  card: { background: "#241C17", border: "1px solid rgba(255,255,255,.08)", borderRadius: 18, padding: 20 },
  input: { width: "100%", background: "#17120F", border: "1.5px solid rgba(255,255,255,.14)", borderRadius: 12, padding: "13px 15px", color: "#fff", fontSize: 16, outline: "none", boxSizing: "border-box" },
