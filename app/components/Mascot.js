...
//
//  • Ring — answers your calls. A glossy coral sphere: a deep #A63C28 body
...
export function Ring({ size = 100, state = "idle", animated = true, style, className = "" }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="52" cy="61" r="30" fill="#A63C28" />
      ...
      {state === "happy" ? (
        ...
        <>
          <g className={animated ? "ring-eyes" : ""}>
            ...
            <circle className="pupil" cx="41.5" cy="57" r="2.6" fill="#2C1B14" />
            <circle className="pupil" cx="61.5" cy="57" r="2.6" fill="#2C1B14" />
          </g>
          {state === "talking" ? (
...
export function Orbit({ size = 56, onDark = false, style, className = "" }) {
  return (
    ...
    >
      <circle cx="50" cy="50" r="30" fill={onDark ? "#2C1B14" : "#FFFDFB"} stroke="var(--coral)" strokeWidth="7" />
      <circle cx="43" cy="48" r="4" fill={onDark ? "#fff" : "#2C1B14"} />
      <circle cx="57" cy="48" r="4" fill={onDark ? "#fff" : "#2C1B14"} />
      <path d="M44 60 Q50 64 56 60" stroke={onDark ? "#fff" : "#2C1B14"} strokeWidth="3" fill="none" strokeLinecap="round" />
